class PagesController < ApplicationController
  ...
  def reports
    @year_1_start = '1/1/2023'
    @year_1_end = '12/31/2023'
    @year_2_start = '1/1/2024'
    ...
    # @monthly_fixed_costs = mortgage 
      # mortgage = Accounting.where(property_id: property.id,description: 'Mortgage Payment').where('record_date BETWEEN ? AND ?', @year_1_start, @year_1_end).average(:amount)&.to_f || 0.0
